...
<section class="secondary-bg dark text-align-center post-content" data-midnight="dark-bg">
	<div class="container">
		<h6>Subheading</h6>
		<h2>Heading</h2>
		<p>
...
<section class="valign theme-bg dark text-align-center post-content full-height" data-midnight="dark-bg">
	<div class="container">
		<h6>Subheading</h6>
		<h2>Heading</h2>
		<p>
