...
!function(o){o&&o.module("headroom",[]).directive("headroom",function(){return{restrict:"EA",scope:{tolerance:"=",offset:"=",classes:"=",scroller:"@"},link:function(e,r){var n={};o.forEach(Headroom.options,function(o,r){n[r]=e[r]||Headroom.options[r]}),n.scroller&&(n.scroller=o.element(n.scroller)[0]);var t=new Headroom(r[0],n);t.init(),e.$on("destroy",function(){t.destroy()})}}})}(window.angular);
!function(e){"use strict";window.THEMENAME={};var n=window.THEMENAME,t=e(window);e(document.body),e(document.documentElement);n.init=function(){n.setElements(),n.colors(),n.basics(),n.nav(),n.dribbble()},n.setElements=function(){n.elems={},n.elems.html=e("html"),n.elems.body=e("body"),n.elems.main=e("#main"),n.elems.header=e("#header"),n.elems.footer=e("#footer"),n.elems.scrollToTop=e('a[data-scroll-to="top"]')},n.colors=function(){},n.basics=function(){e(function(){window.FastClick.attach(document.body)}),e.simpleAnchors({offset:-1,easing:"easeInOutCubic"}),n.elems.header.midnight(),n.elems.header.headroom({classes:{initial:"headroom",pinned:"header-pinned",unpinned:"header-unpinned",top:"header-top",notTop:"header-not-top"}}),n.elems.main.find(".split-content .columns-50").matchHeight(),n.elems.main.find(".post-list .post").matchHeight(),n.elems.main.find(".post-content .container > *, img, h6, h5, h4, h3, h2, p, span, .btn").addClass("wow fadeIn"),console.log("psst..i give a shit. =)"),(new WOW).init({offset:Math.min(.1*e(window).height(),80)});var t=Math.floor(Math.random()*n.elems.main.find(".random").length);n.elems.main.find(".random").eq(t).show()},n.instagram=function(){var n="24765686",t="20",a="695497474.45e59c8.a618fb95f14947b08d2137fd66797bbd";e.ajax({type:"GET",dataType:"jsonp",cache:!1,url:"https://api.instagram.com/v1/users/"+n+"/media/recent/?access_token="+a,success:function(n){for(var a=0;t>a;a++)e(".instagram-feed").append('<li class="instagram-item"><a target="_blank" href="'+n.data[a].link+'" class="instagram-image overlay block" style="background-image: url('+n.data[a].images.low_resolution.url+')"><div class="content"><h5>'+n.data[a].caption.text+"</h5></div></a></li>")}})},n.dribbble=function(){e.getJSON("http://dribbble.com/kiriaze/shots.json?callback=?",function(n){e.each(n.shots,function(n,t){e(".dribbble-feed").append('<li class="dribbble-item"><a target="_blank" href="'+t.url+'" class="dribbble-image overlay block" style="background-image: url('+t.image_teaser_url+')"><div class="content"><h5>'+t.title+"</h5></div></a></li>")})})},n.nav=function(){n.elems.main.on("click",".nav-trigger",function(){e(".menu-overlay, #header, body").toggleClass("nav-open")}),e('a:not([href*="#"],[href*="javascript:;"])').on("click",function(t){t.preventDefault(),n.elems.body.toggleClass("fadeOut");var a=e(this).attr("href");setTimeout(function(){window.location.href=a},100)})},t.load(function(){n.elems.header.css("visibility","visible");var t=e(".giflinks");t.length&&GifLinks(t)}),t.resize(function(e){}),e(document).ready(function(){n.init()})}(window.jQuery);
...
!function t(e,r,n){function i(u,a){if(!r[u]){if(!e[u]){var c="function"==typeof require&&require;if(!a&&c)return c(u,!0);if(o)return o(u,!0);throw new Error("Cannot find module '"+u+"'")}var s=r[u]={exports:{}};e[u][0].call(s.exports,function(t){var r=e[u][1][t];return i(r?r:t)},s,s.exports,t,e,r,n)}return r[u].exports}for(var o="function"==typeof require&&require,u=0;u<n.length;u++)i(n[u]);return i}({1:[function(t,e,r){function n(t,e){var r=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");r.open("GET",t,!0),r.onreadystatechange=function(){if(200==r.status&&4==r.readyState)try{e(null,JSON.parse(r.responseText))}catch(t){e(t,null)}},r.send()}e.exports={load:n}},{}],2:[function(t,e,r){function n(t){return u(t)?c(t):a(t)?s(t):void 0}function i(){return g.length=0,g}function o(){return g}function u(t){return!!t&&"[object Object]"==Object.prototype.toString.call(t)}function a(t){return!!t&&"[object Array]"==Object.prototype.toString.call(t)}function c(t){return g.push(t),g}function s(t){for(var e=[],r=0;r<t.length;r++)u(t[r])&&e.push(c(t[r]));return e}function f(t){return t?p(g,t,y.searchStrategy,y):[]}function l(e){y=e||{},y.fuzzy=e.fuzzy||!1,y.limit=e.limit||10,y.searchStrategy=t(e.fuzzy?"./SearchStrategies/FuzzySearchStrategy":"./SearchStrategies/LiteralSearchStrategy")}function p(t,e,r,n){for(var i=[],o=0;o<t.length&&i.length<n.limit;o++){var u=h(t[o],e,r,n);u&&i.push(u)}return i}function h(t,e,r,n){for(var i in t)if(!S(t[i],n.exclude)&&r.matches(t[i],e))return t}function S(t,e){var r=!1;e=e||[];for(var n=0;n<e.length;n++){var i=e[n];!r&&new RegExp(t).test(i)&&(r=!0)}return r}e.exports={put:n,clear:i,get:o,search:f,setOptions:l};var g=[],y={};y.fuzzy=!1,y.limit=10,y.searchStrategy=t(y.fuzzy?"./SearchStrategies/FuzzySearchStrategy":"./SearchStrategies/LiteralSearchStrategy")},{"./SearchStrategies/FuzzySearchStrategy":3,"./SearchStrategies/LiteralSearchStrategy":4}],3:[function(t,e,r){function n(){function t(t){return new RegExp(t.split("").join(".*?"),"gi")}this.matches=function(e,r){return"string"!=typeof e?!1:(e=e.trim(),!!t(r).test(e))}}e.exports=new n},{}],4:[function(t,e,r){function n(){this.matches=function(t,e){return"string"!=typeof t?!1:(t=t.trim(),t.toLowerCase().indexOf(e.toLowerCase())>=0)}}e.exports=new n},{}],5:[function(t,e,r){function n(t){o=t||{},o.templatePattern=t.templatePattern||/\{(.*?)\}/g}function i(t,e){return t.replace(o.templatePattern,function(t,r){return e[r]||t})}e.exports={render:i,setOptions:n};var o={};o.templatePattern=/\{(.*?)\}/g},{}],6:[function(t,e,r){!function(e,r,n){"use strict";function i(t){S.put(v.json),l()}function o(t){g.load(t,function(e,r){e?u("failed to get JSON ("+t+")"):(S.put(r),l())})}function u(t){throw new Error("SimpleJekyllSearch --- "+t)}function a(t){for(var e=0;e<y.length;e++){var r=y[e];t[r]||u("You must specify a "+r)}var n=t;for(var i in v)n[i]=t[i]||v[i];return n}function c(t){try{return t instanceof Object&&JSON.parse(JSON.stringify(t))}catch(e){return!1}}function s(){v.resultsContainer.innerHTML=""}function f(t){v.resultsContainer.innerHTML+=t}function l(){v.searchInput.addEventListener("keyup",function(t){return 0==t.target.value.length?void s():void p(S.search(t.target.value))})}function p(t){if(s(),0==t.length)return f(v.noResultsText);for(var e=0;e<t.length;e++)f(h.render(v.searchResultTemplate,t[e]))}var h=t("./Templater"),S=t("./Repository"),g=t("./JSONLoader"),y=["searchInput","resultsContainer","json"],v={searchInput:null,resultsContainer:null,json:[],searchResultTemplate:'<li><a href="{url}" title="{desc}">{title}</a></li>',noResultsText:"No results found",limit:10,fuzzy:!1,exclude:[]};e.SimpleJekyllSearch=function(t){v=a(t),S.setOptions(t),c(v.json)?i(v.json):o(v.json)},e.SimpleJekyllSearch.init=e.SimpleJekyllSearch}(window,document)},{"./JSONLoader":1,"./Repository":2,"./Templater":5}]},{},[6]);
...
var GifLinks=function(){"use strict";function n(n,e){for(var t in e)t in n||(n[t]=e[t]);return n}function e(n,e){for(var t in e)n.style[t]=e[t]}function t(n,e){if(n.length)for(var t=0;t<n.length;t++)e===!0?i(n[t]):o(n[t]);else e===!0?i(n):o(n)}function i(n){var e=n.getAttribute("data-src");if(e){var t=new Image;t.onload=function(){n.className+=" preloaded",o(n)},t.src=e}}function o(n){n.addEventListener("mouseover",function(){c(this)},!1),n.addEventListener("touchstart",function(){c(this)},!1),n.addEventListener("mouseout",function(){s()},!1),n.addEventListener("touchmove",function(n){n.preventDefault(),s()},!1),n.addEventListener("click",function(){s()},!1),n.addEventListener("dblclick",function(){s()},!1),a(n)}function a(n){n.className+=" giflink ready",n.href?n.className+=" has-link":n.className+=" no-link"}function r(){var n={backgroundPosition:"50% 50%",backgroundSize:"cover",pointerEvents:"none",position:"fixed",zIndex:"999999",display:"none",height:"100%",width:"100%",margin:"0px",left:"0px",top:"0px"};u=document.createElement("div"),u.className="giflinks-overlay",e(u,n),l.appendChild(u)}function c(n){var e=n.getAttribute("data-src");e?(u.style.backgroundImage="url("+e+")",u.style.display="block"):console.log("Sorry, an element doesn't have a data-src!")}function s(){u.style.display="none",u.style.backgroundImage=""}function d(n,e){l=document.body,r();var i=!1;e&&e.preload&&(i=!!e.preload),t(n,i)}var l,u;return n(d,{})}();
!function(t,o,s,i){function a(o,s){this.element=o,this.$elem=t(this.element),this.options=t.extend({},e,s),this._defaults=e,this._name=n,this.link=o.selector?o.selector:"[data-scroll-to]",this.$link=t(this.link),this.init()}var n="simpleAnchors",e={duration:800,easing:"swing",activeClass:"active",offset:0,autoBuild:!1,sections:"h2",sectionEl:"section",wrapper:".test",navEl:"#nav"};t.extend(a.prototype,{init:function(){var o=(this.options.activeClass,this.options.offset);t("body").attr("data-scroll-target","top"),t("body").on("click",this.link,{myOptions:this.options},function(s){s.preventDefault();var i=t(this),a=i.data("scroll-to"),n=t("[data-scroll-target="+a+"]"),e=i.data("scroll-offset")?i.data("scroll-offset"):o,l=s.data.myOptions,r=l.duration,c=l.easing;n&&n.offset()&&(/(iPhone|iPod)\sOS\s6/.test(navigator.userAgent)?t("html, body").animate({scrollTop:n.offset().top},r,c):t("html, body").animate({scrollTop:n.offset().top-e},r,c))}),this.autoBuild(),this.scrollSpy()},scrollSpy:function(s,i){var a=this.options.activeClass,n=(this.$link,this.options.offset+1);t(o).scroll(function(){var s=t(o).scrollTop();t("[data-scroll-to]").each(function(){var o=t(this),i=o.data("scroll-to"),e=t("[data-scroll-target="+i+"]");e.length&&(e.position().top-n<=s&&e.position().top-n+e.outerHeight()>s?(t("[data-scroll-to]").removeClass(a),"top"!=i&&o.addClass(a)):o.removeClass(a))})})},autoBuild:function(o,s){if(this.options.autoBuild){var i=this.options.sections,a=this.options.sectionEl,n=this.options.wrapper,e=this.options.navEl,l=t("<ul />").prependTo(e);t(n).find(i).each(function(){var o=t("<li />").appendTo(l),s=t(this).text().replace(/ /g,"_");t('<a href="javascript:;" />').attr("data-scroll-to",s).text(s).appendTo(o);t(this).nextUntil(i).addBack().wrapAll("<"+a+' data-scroll-target="'+s+'" />')})}}}),t.fn[n]=function(o){t.data(this,"plugin_"+n)||t.data(this,"plugin_"+n,new a(this,o))},t[n]=function(s){var i=t(o);return i.simpleAnchors.apply(i,Array.prototype.slice.call(arguments,0))}}(jQuery,window,document);
