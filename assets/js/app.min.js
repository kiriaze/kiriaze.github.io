...
!function(e){"use strict";window.THEMENAME={};{var n=window.THEMENAME,o=e(window);e(document.body),e(document.documentElement)}n.init=function(){n.setElements(),n.colors(),n.basics(),n.nav()},n.setElements=function(){n.elems={},n.elems.html=e("html"),n.elems.body=e("body"),n.elems.main=e("#main"),n.elems.header=e("#header"),n.elems.footer=e("#footer"),n.elems.scrollToTop=e('a[data-scroll-to="top"]')},n.colors=function(){},n.basics=function(){e(function(){window.FastClick.attach(document.body)}),e.simpleAnchors({offset:-1,easing:"easeInOutCubic"}),n.elems.header.midnight(),n.elems.header.headroom({classes:{initial:"headroom",pinned:"header-pinned",unpinned:"header-unpinned",top:"header-top",notTop:"header-not-top"}}),n.elems.main.find(".split-content .columns-50").matchHeight(),n.elems.main.find(".post-list .post").matchHeight(),n.elems.main.find(".post-content .container > *, img, h6, h5, h4, h3, h2, p, .btn").addClass("wow fadeIn"),console.log("psst..i give a shit. =)"),(new WOW).init({offset:Math.min(.1*e(window).height(),80)});var o=Math.floor(Math.random()*n.elems.main.find(".random").length);n.elems.main.find(".random").eq(o).show()},n.nav=function(){n.elems.main.on("click",".nav-trigger",function(){e(".menu-overlay, #header, body").toggleClass("nav-open")}),e('a:not([href*="#"],[href*="javascript:;"])').on("click",function(o){o.preventDefault(),n.elems.body.toggleClass("fadeOut");var t=e(this).attr("href");setTimeout(function(){window.location.href=t},100)})},o.load(function(){n.elems.header.css("visibility","visible");var o=e(".giflinks");o.length&&GifLinks(o)}),o.resize(function(e){}),e(document).ready(function(){n.init()})}(window.jQuery);
