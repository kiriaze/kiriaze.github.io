...
!function t(e,n,r){function i(u,a){if(!n[u]){if(!e[u]){var c="function"==typeof require&&require;if(!a&&c)return c(u,!0);if(o)return o(u,!0);throw new Error("Cannot find module '"+u+"'")}var s=n[u]={exports:{}};e[u][0].call(s.exports,function(t){var n=e[u][1][t];return i(n?n:t)},s,s.exports,t,e,n,r)}return n[u].exports}for(var o="function"==typeof require&&require,u=0;u<r.length;u++)i(r[u]);return i}({1:[function(t,e,n){function r(t,e){var n=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");n.open("GET",t,!0),n.onreadystatechange=function(){if(200==n.status&&4==n.readyState)try{e(null,JSON.parse(n.responseText))}catch(t){e(t,null)}},n.send()}e.exports={load:r}},{}],2:[function(t,e,n){function r(){function t(t){return new RegExp(t.split("").join(".*?"),"gi")}this.matches=function(e,n){return"string"!=typeof e?!1:(e=e.trim(),!!t(n).test(e))}}e.exports=new r},{}],3:[function(t,e,n){function r(){this.matches=function(t,e){return"string"!=typeof t?!1:(t=t.trim(),t.toLowerCase().indexOf(e.toLowerCase())>=0)}}e.exports=new r},{}],4:[function(t,e,n){function r(t,e){return e?o(t,e,c.searchStrategy,c):[]}function i(e){c=e||{},c.fuzzy=e.fuzzy||!1,c.limit=e.limit||10,c.searchStrategy=t(e.fuzzy?"./SearchStrategies/fuzzy":"./SearchStrategies/literal")}function o(t,e,n,r){for(var i=[],o=t.get(),a=0;a<o.length&&i.length<r.limit;a++){var c=u(o[a],e,n,r);c&&i.push(c)}return i}function u(t,e,n,r){for(var i in t)if(!a(t[i],r.exclude)&&n.matches(t[i],e))return t}function a(t,e){var n=!1;e=e||[];for(var r=0;r<e.length;r++){var i=e[r];!n&&new RegExp(t).test(i)&&(n=!0)}return n}var c={};c.fuzzy=!1,c.limit=10,c.searchStrategy=t(c.fuzzy?"./SearchStrategies/fuzzy":"./SearchStrategies/literal"),e.exports={search:r,setOptions:i}},{"./SearchStrategies/fuzzy":2,"./SearchStrategies/literal":3}],5:[function(t,e,n){function r(t){return u(t)?c(t):a(t)?s(t):void 0}function i(){return f.length=0,f}function o(){return f}function u(t){return!!t&&"[object Object]"==Object.prototype.toString.call(t)}function a(t){return!!t&&"[object Array]"==Object.prototype.toString.call(t)}function c(t){return f.push(t),t}function s(t){for(var e=[],n=0;n<t.length;n++)u(t[n])&&e.push(c(t[n]));return e}e.exports={put:r,clear:i,get:o};var f=[]},{}],6:[function(t,e,n){function r(t){o=t||{},o.templatePattern=t.templatePattern||/\{(.*?)\}/g}function i(t,e){return t.replace(o.templatePattern,function(t,n){return e[n]||t})}e.exports={render:i,setOptions:r};var o={};o.templatePattern=/\{(.*?)\}/g},{}],7:[function(t,e,n){!function(e,n,r){"use strict";function i(t){g.put(d.json),l()}function o(t){y.load(t,function(e,n){e?u("failed to get JSON ("+t+")"):(g.put(n),l())})}function u(t){throw new Error("SimpleJekyllSearch --- "+t)}function a(t){for(var e=0;e<v.length;e++){var n=v[e];t[n]||u("You must specify a "+n)}var r=t;for(var i in d)r[i]=t[i]||d[i];return r}function c(t){try{return t instanceof Object&&JSON.parse(JSON.stringify(t))}catch(e){return!1}}function s(){d.resultsContainer.innerHTML=""}function f(t){d.resultsContainer.innerHTML+=t}function l(){d.searchInput.addEventListener("keyup",function(t){return 0==t.target.value.length?void s():void p(h.search(g,t.target.value))})}function p(t){if(s(),0==t.length)return f(d.noResultsText);for(var e=0;e<t.length;e++)f(S.render(d.searchResultTemplate,t[e]))}var h=t("./Searcher"),S=t("./Templater"),g=t("./Store"),y=t("./JSONLoader"),v=["searchInput","resultsContainer","json"],d={searchInput:null,resultsContainer:null,json:[],searchResultTemplate:'<li><a href="{url}" title="{desc}">{title}</a></li>',noResultsText:"No results found",limit:10,fuzzy:!1,exclude:[]};e.SimpleJekyllSearch=function(t){d=a(t),h.setOptions(t),c(d.json)?i(d.json):o(d.json)},e.SimpleJekyllSearch.init=e.SimpleJekyllSearch}(window,document)},{"./JSONLoader":1,"./Searcher":4,"./Store":5,"./Templater":6}]},{},[7]);
