...
!function(e){"use strict";window.THEMENAME={};{var n=window.THEMENAME,t=e(window);e(document.body),e(document.documentElement)}n.init=function(){n.setElements(),n.colors(),n.basics(),n.nav()},n.setElements=function(){n.elems={},n.elems.html=e("html"),n.elems.body=e("body"),n.elems.main=e("#main"),n.elems.header=e("#header"),n.elems.footer=e("#footer"),n.elems.scrollToTop=e('a[data-scroll-to="top"]')},n.colors=function(){},n.basics=function(){e(function(){window.FastClick.attach(document.body)}),e.simpleAnchors({offset:-1,easing:"easeInOutCubic"}),n.elems.main.find("#header").midnight(),n.elems.main.find(".split-content .columns-50").matchHeight(),n.elems.main.find(".post-list .post").matchHeight(),n.elems.main.find(".post-content p").attr("data-sr","enter bottom"),console.log("psst..i give a shit. =)")},n.nav=function(){n.elems.main.on("click",".nav-trigger",function(){e(".menu-overlay, #header, body").toggleClass("nav-open")}),e('a:not([href*="#"],[href*="javascript:;"])').on("click",function(t){t.preventDefault(),n.elems.body.toggleClass("fadeOut");var o=e(this).attr("href");setTimeout(function(){window.location.href=o},100)})},t.load(function(){var e={};window.sr=new scrollReveal(e)}),t.resize(function(e){}),e(document).ready(function(){n.init()})}(window.jQuery);
