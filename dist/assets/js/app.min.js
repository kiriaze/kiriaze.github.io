...
!function(e){"use strict";window.THEMENAME={};{var t=window.THEMENAME,n=e(window);e(document.body),e(document.documentElement)}t.init=function(){t.setElements(),t.colors(),t.basics(),t.nav()},t.setElements=function(){t.elems={},t.elems.html=e("html"),t.elems.body=e("body"),t.elems.main=e("#main"),t.elems.header=e("#header"),t.elems.footer=e("#footer"),t.elems.scrollToTop=e('a[data-scroll-to="top"]')},t.colors=function(){},t.basics=function(){window.back_to_top&&n.scroll(function(){e(this).scrollTop()>300?t.elems.scrollToTop.addClass("fadeIn"):t.elems.scrollToTop.removeClass("fadeIn")}),e(function(){window.FastClick.attach(document.body)}),e.simpleAnchors({offset:-1,easing:"easeInOutCubic"}),t.elems.main.on({mouseenter:function(){e(".work-title-list a").not(e(this)).addClass("hover")},mouseleave:function(){e(".work-title-list a").not(e(this)).removeClass("hover")}},".work-title-list a.completed"),t.elems.main.find("#header").midnight(),t.elems.main.find(".split-content .columns-50").matchHeight(),t.elems.main.find(".post-list .post").matchHeight(),t.elems.main.find(".post-content p").attr("data-sr","enter bottom"),console.log("psst..i give a shit. =)")},t.nav=function(){t.elems.main.on("click",".nav-trigger",function(){e(".menu-overlay, #header, body").toggleClass("nav-open")}),e('a:not([href*="#"],[href*="javascript:;"])').on("click",function(n){n.preventDefault(),t.elems.body.toggleClass("fadeOut");var o=e(this).attr("href");setTimeout(function(){window.location.href=o},100)})},t.ajax=function(){var n=window.History,o=!1,i=!1,a=e("#ajax-container"),s=e("#latest-post"),l=e("#post-index");return s.show(),l.hide(),(1===window.location.pathname.indexOf("page")||1===window.location.pathname.indexOf("tag"))&&(s.hide(),l.show()),n.enabled?(n.Adapter.bind(window,"statechange",function(){var r=n.getState();e.get(r.url,function(n){var r=e(n),d=e("#ajax-container",r).contents();document.title=r.filter("title").text(),a.fadeOut(500,function(){e("html, body").animate({scrollTop:0}),s=d.filter("#latest-post"),l=d.filter("#post-index"),i===!0?s.hide():(s.show(),l.hide()),a.html(d).promise().done(function(){e("#header").midnight(),t.medium(),sr.init(),a.fadeIn(500)}),NProgress.done(),o=!1,i=!1})}).fail(function(){NProgress.done(),location.reload()})}),void e("body").on("click",".js-ajax-link, .pagination a",function(t){if(t.preventDefault(),o===!1){var a=n.getState(),s=e(this).attr("href"),l=e(this).attr("title")||null;s!==a.url.replace(/\/$/,"")&&s!==a.hash&&(o=!0,(e(this).hasClass("js-show-index")||e(this).parent(".pagination").length>0)&&(i=!0),NProgress.start(),n.pushState({},l,s))}})):!1},n.load(function(){var e={};window.sr=new scrollReveal(e),t.elems.body.addClass("fadeIn")}),n.resize(function(e){}),e(document).ready(function(){t.init()})}(window.jQuery);
